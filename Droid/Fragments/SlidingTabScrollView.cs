...
namespace SlidingTabLayoutTutorial
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        private const int TITLE_OFFSET_DIPS = 34;
        private const int TAB_VIEW_PADDING_DIPS = 26;
        private const int TAB_VIEW_TEXT_SIZE_SP = 18;
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i < adapter.Count; i++)
            {
				...
				tabView.Text = ((Leadbox.SlidingTabsFragment.SamplePagerAdapter)adapter).GetHeaderTitle(i);
