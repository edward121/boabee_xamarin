...
{
	public partial class DefaultShareOverviewViewController : UIViewController, IUITableViewDataSource, IUITableViewDelegate
	{
        public List<DBfileTO> addedFiles = new List<DBfileTO>();

		public DefaultShareOverviewViewController (IntPtr handle) : base (handle)
		{
		}
...
//			this.addedFiles = DBLocalDataStore.GetInstance().GetDefaultFileTO();
		...
		public UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
		{
			...
			DefaultShareOverviewCell cell = (DefaultShareOverviewCell)tableView.DequeueReusableCell("FileCell", indexPath);
