...
{
	[Register ("EmailsSentViewController")]
	partial class EmailsSentViewController
	{
		[Outlet]
		...
		[Outlet]
		UIKit.UILabel emailsSentLabel { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (emailsSentLabel != null) {
				emailsSentLabel.Dispose ();
				emailsSentLabel = null;
			}
